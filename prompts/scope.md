...
3. **Write the spec** — create `.codex/specs/YYYY-MM-DD-<slug>/spec.md` with Context, Decision, Constraints, Design, and Risks
4. **Plan the tasks** — create `tasks.md` with parallelized groups following the spec-workflow conventions (research group first, review gates, documentation last)
5. **Set active** — write the slug to `.codex/specs/currentspec.md`
