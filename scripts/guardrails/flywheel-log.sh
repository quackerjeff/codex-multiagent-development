#!/bin/bash
# Helper: Lightweight turn index for flywheel analysis.
# Example wrapper event: assistant stop
# Writes one minimal JSONL entry per turn to ~/.codex/flywheel-log.jsonl
#
...
#
# Pairs with flywheel-correction.sh — that helper detects corrections; this
# helper just records what came before.
...
LOG_PATH = os.path.realpath(os.path.expanduser("~/.codex/flywheel-log.jsonl"))
