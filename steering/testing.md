...
- Validate that the implemented behavior satisfies the spec in realistic scenarios
- Record what was tested manually versus automatically
- Flag gaps where tests pass but acceptance criteria remain unproven
- Report release confidence separately from code review
